...
from speedy_pebble_util_kerasocr import updatePebbleLocation
from speedy_kerasocr_util import keras_prediction_with_accuracy
            ...
            if not currentPebble.isConverged:
                ...
                for i in range(len(pebbleDigitsCrops)):
                    ...
                    for f in range(len(fixedImages)):
                        ...
                        # prediciton
                        predImg, kerasPred, digitAccuracy, confusionMatrix = keras_prediction_with_accuracy(
                            downsizedImage, pebbleActualNumber, digitAccuracy, confusionMatrix)
                        if kerasPred is not None:
                            # update digits
                            currentPebble.addDigits(kerasPred)
